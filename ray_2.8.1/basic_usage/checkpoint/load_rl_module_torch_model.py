...
LastEditTime: 2024-03-02 09:22:35
LastEditors: Morphlng
Description: Demonstrate how to load a raw rl_module model and perform inference.
FilePath: /rllib_examples/ray_2.8.1/basic_usage/checkpoint/load_rl_module_torch_model.py
"""
...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        "--model",
        type=str,
        default=os.path.join(__file__, "./model/rl_module/model.pt"),
    )
